...
mixin AppColors {
  static const Color kPrimaryColor = Color(0xff6E8BF5);
  static const Color kPrimaryBlack = Color(0xff2C2A2B);
  ...
  static const Color kBlueOverLightAlpha32 = Color(0xffADD3FF);
